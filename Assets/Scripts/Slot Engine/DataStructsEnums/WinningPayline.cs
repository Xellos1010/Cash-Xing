...
public class WinningPayline
{
    ...
    public WinningSymbolNode[] winning_symbols;

    public WinningPayline(Payline payline, WinningSymbolNode[] winning_symbols)
    {
    ...
    internal bool IsSymbolOnWinningPayline(int reel, int slot, int reel_start_padding, WinningSymbolNode symbol_to_check)
    {
    ...
    private bool IsSymbolWinningSymbol(WinningSymbolNode symbol_to_check)
    {
        bool output = false;
        for (int i = 0; i < winning_symbols.Length; i++)
        {
    ...
    internal WinningSymbolNode GetWinningWymbol()
    {
