...
using UnityEngine;
    ...
    public static class MatrixEvaluation
    {
        ...
        //Matrix Evaluation
        public static eEvaluationDirection ReelEvaluationDirection = eEvaluationDirection.Both;
        public static int[] LinePays;
        public static int iPayLines = 99;
        ...
        //{
        //    //99paylines_3x5
        //    StreamReader rReader = new StreamReader(Application.dataPath + "/Resources/Data/" + MatrixGenerator._instance.iPayLines + "paylines_"+MatrixGenerator._instance.mMatrixType.ToString());
        //    string line;
        ...
        //        {
        //            iConvertedLogic[i] = (Convert.ToInt16(sLogicToConvert[i]) + MatrixGenerator._instance.slot_spin_paddingSlots -1);
        ...
        //    rReader.Dispose();
        //    Debug.Log("Line Pays Logic has been set for " + "Resources/Data/" + MatrixGenerator._instance.iPayLines + "paylines_"+MatrixGenerator._instance.mMatrixType.ToString());
        //}
