...
namespace Slot_Engine.Matrix
{
    ...
    public class SlotManager : MonoBehaviour
    {
        ...
        public StripManager reel_parent;
            ...
            else
            {
                ...
                if (reel_parent.randomSetSymbolsOnTraverseReel)
                {
                    ...
                    if (!symbol_set)
                    {
                        ...
                        NodeDisplaySymbol symbol = reel_parent.configurationObjectParent.managers.endConfigurationManager.GetRandomWeightedSymbol(StateManager.enCurrentMode).Result;
                        SetDisplaySymbolTo(symbol);
                    }
                }
            }
